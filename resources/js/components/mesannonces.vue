                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 align-items-center ">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Colis" class="form-control border-md"
                                       style="background-color:#FFFFFF;border-color:#C1EBFF;">
                            </div>
                            <div class="col-md-12">
                                <p>
                                    <input type="checkbox" id="test1"/>
                                    <label for="test1" aria-describedby="label">Publié</label>
                                </p>
                                <p>
                                    <input type="checkbox" id="test2"/>
                                    <label for="test2" aria-describedby="label">Reservé</label>
                                </p>
                                <p>
                                    <input type="checkbox" id="test3"/>
                                    <label for="test3" aria-describedby="label">Confirmé</label>
                                </p>
                            </div>
                        ...
                        <div class="col-md-8">
                            <div style="cursor:pointer;" v-for="annonce in annonces" :key="annonce.id"
                                 @click="show(annonce.id)" class="col-md-12" data-toggle="modal"
                                            ...
                                            <div class="col-md-12 p-4">
                                                <div class="row p-4">
                                                    <div class="col-md-5 p-2"
                                                         style="background-color:#C9EEFF;border-radius: 4px;text-align: center;height: 52px!important;">
                                                    ...
                                                    <div class="col-md-5 p-2"
                                                         style="background-color:#C9EEFF;border-radius: 4px;text-align: center;height: 52px!important; ">
                                                        <p style="font-size: 20px;color:#00A1ED;">
                                                            <img
